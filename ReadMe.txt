...
Build a new controller, new service, and add a method on TheMovieDbDispatcher to call out to "The Movie DB" Api (https://developers.themoviedb.org/3/movie/get-movie-alternative-titles) 
...
Also the "movies" API seems to have udpated to "movie"!