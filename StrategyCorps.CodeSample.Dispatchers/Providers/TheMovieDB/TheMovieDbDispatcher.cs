...
{
    public class TheMovieDbDispatcher : TheMovieDbDispatcherBase, IEntertainmentDispatcher, IMovieEntertainmentDispatcher
    {
        private readonly ILogger _logger;
        private readonly IMapper _mapper;
        private readonly IRestClient _restClient;

        //TODO: Consider rename to match responsibility and/or splitting dispatcher
        ...
        private MovieSearchResponseDto MapGetMoviesResponse(IRestResponse response)
        {
            ...
            {
                case HttpStatusCode.OK:
                    var movieSearchResponse = JsonConvert.DeserializeObject<MovieSearchResponse>(response.Content);
